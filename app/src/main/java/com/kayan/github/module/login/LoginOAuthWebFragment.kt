...
import com.kayan.github.kotlin.databinding.FragmentLoginOauthBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loginViewModel.loginResult.observe(this, Observer { result ->
            ...
            if (result != null && result == true) {
                navigationPopUpTo(view, null, R.id.action_loginOAuthFragment_to_myFragment, false, false)
            } else {
