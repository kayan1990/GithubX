...
import com.kayan.github.common.net.FlatMapResponse2Result
import com.kayan.github.common.net.FlatMapResult2Response
import com.kayan.github.common.net.ResultProgressObserver
import com.kayan.github.common.net.RetrofitFactory
import com.kayan.github.common.utils.Debuger
...
class LoginRepository @Inject constructor(private val retrofit: Retrofit, private val userRepository: UserRepository) {
     ...
     * 获取token
     */
    private fun getCodeTokenObservable(code: String): Observable<String> {
        return retrofit.create(LoginService::class.java)
